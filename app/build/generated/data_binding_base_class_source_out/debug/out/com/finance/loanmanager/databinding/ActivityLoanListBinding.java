...
public final class ActivityLoanListBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityLoanListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLoanListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_loan_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLoanListBinding bind(@NonNull View rootView) {
