...
public final class ActivityBackgroundSettingsBinding implements ViewBinding {
  ...
  private ActivityBackgroundSettingsBinding(@NonNull ScrollView rootView,
      ...
      @NonNull View colorCircleRose, @NonNull GridLayout gridThemes,
      @NonNull LinearLayout themeItemBlue, @NonNull LinearLayout themeItemCyan,
      @NonNull LinearLayout themeItemGreen, @NonNull LinearLayout themeItemOrange,
      @NonNull LinearLayout themeItemPurple, @NonNull LinearLayout themeItemRose) {
  ...
  public static ActivityBackgroundSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBackgroundSettingsBinding((ScrollView) rootView, btnResetBackground,
          ...
          colorCircleRose, gridThemes, themeItemBlue, themeItemCyan, themeItemGreen,
          themeItemOrange, themeItemPurple, themeItemRose);
    }
